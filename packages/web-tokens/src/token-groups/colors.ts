...
export const colors = {
  ...
  "splash-screen-color": {
    ...
    description: "Splash screen color text",
  },
  "splash-screen-background": {
    value: "rgba(241, 250, 254, 1)",
    description: "Splash screen background color",
  },
  "background-navbar-active": {
    value: "rgba(0, 26, 65, 0.7)",
    description: "Background color of navbar link when active",
  },
};
